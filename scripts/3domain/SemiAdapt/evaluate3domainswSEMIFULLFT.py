"""
Evaluation script for SemiAdapt NLLB models with embedding-based inference on English–Irish translation.
...
# Domain-specific Semi-Full Fine-Tuned model checkpoints
NLLB_MODELS = {
    "general": "models/nllb_3domain_general/final_model",
    "medical": "models/nllb_3domain_medical_semifullft/final_model",
    "wikinews": "models/nllb_3domain_wikinews_semifullft/final_model",
    "legal": "models/nllb_3domain_legal_semifullft/final_model",
}
...
# Output paths
OUTPUT_TXT = "results/bleu_scores_semifullft.txt"
OUTPUT_JSON = "results/bleu_scores_semifullft.json"
...
def load_tokenizer_model(model_path: str):
    """Load tokenizer and full fine-tuned model (Semi-Full FT)."""
