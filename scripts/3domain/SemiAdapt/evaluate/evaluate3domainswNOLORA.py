"""
Evaluation script for full-domain fine-tuned NLLB models (no LoRA) on English–Irish translation.
...
# Base model (general domain, full fine-tuned)
BASE_MODEL = "models/nllb_3domain_general/final_model"

# Domain-specific model checkpoints
NLLB_MODELS = {
    "general": "models/nllb_3domain_general/final_model",
    "medical": "models/nllb_3domain_medical_noLORA/final_model",
    "wikinews": "models/nllb_3domain_wikinews_noLORA/final_model",
    "legal": "models/nllb_3domain_legal_noLORA/final_model",
}
...
# Output paths
OUTPUT_TXT = "results/bleu_scores_noLORA.txt"
OUTPUT_JSON = "results/bleu_scores_noLORA.json"
...
def load_tokenizer_model(model_path: str):
    """Load a tokenizer and full fine-tuned model (no LoRA)."""
...
def load_texts(path):
    """Load lines from a text file, removing blanks and trailing whitespace."""
