"""
Evaluation script for 4-domain fully fine-tuned NLLB models (no LoRA) on English–Irish translation.
...
# Domain-specific full fine-tuned model checkpoints
NLLB_MODELS = {
    "general": "models/nllb_4domain_general/final_model",
    "medical": "models/nllb_4domain_medical_nolora/final_model",
    "wikinews": "models/nllb_4domain_wikinews_nolora/final_model",
    "legal": "models/nllb_4domain_legal_nolora/final_model",
}
...
# Output paths
OUTPUT_TXT = "results/bleu_scores_4domains_nolora.txt"
OUTPUT_JSON = "results/bleu_scores_4domains_nolora.json"
...
def load_tokenizer_model(model_path: str):
    """Load tokenizer and model for full fine-tuning (no LoRA)."""
