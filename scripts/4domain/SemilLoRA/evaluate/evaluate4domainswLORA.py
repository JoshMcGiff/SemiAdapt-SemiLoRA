"""
Evaluation script for 4-domain LoRA NLLB models on English–Irish translation.
...
# Base model (general domain; used for adapter loading)
BASE_MODEL = "models/nllb_4domain_general/final_model"

# Domain-specific models (general = full FT; others = LoRA adapters)
NLLB_MODELS = {
...
# Output files
OUTPUT_TXT = "results/bleu_scores_4domains_lora.txt"
OUTPUT_JSON = "results/bleu_scores_4domains_lora.json"
...
def load_full_model(model_path: str):
    """Load a full fine-tuned model (no LoRA)."""
...
def load_texts(path: str):
    """Load text lines, removing blanks."""
